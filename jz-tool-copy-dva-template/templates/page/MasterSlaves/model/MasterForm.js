...
import slave1ModelLike, { getInitState as getInitState4Sub1 } from './_slave1';
import slave2ModelLike, { getInitState as getInitState4Sub2 } from './_slave2';

const fidAdapter = new FidGroupedAdapter('{{appNamespace}}');
